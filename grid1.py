...
#app.css.append_css({"external_url": "C:/[my path]/bWLwgP.css"})
...
# @app.callback(
#     dash.dependencies.Output("distortion-graph", "figure"),
#     [dash.dependencies.Input("scenario-selected", "value")]
# )
...
#                                                     "tickfont": {"size": 10},
#                                                     "range": [-5, 5]},
#                                                 "camera": {"eye": {"x": 2, "y": 1, "z": 1.5}}, "aspectmode": "manual",
#                                                 "aspectratio": {"x": 1, "y": 1, "z": 0.3}}))
#
#         fig.update_layout(
#             title={
